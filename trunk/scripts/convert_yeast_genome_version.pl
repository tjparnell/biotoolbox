...
BED, SGR, and text files with chromosome, start, stop, and/or position 
columns. BigWig files are also supported by going through a conversion 
step.
