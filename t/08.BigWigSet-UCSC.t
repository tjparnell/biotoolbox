...
# Test script for Bio::ToolBox::db_helper::bigwig
...
BEGIN {
	if ( eval { require Bio::DB::BigWigSet; 1 } ) {
		...
		skip_all('Alternate module Bio::DB::BigWigSet not available');
	}
	## no critic
...
isa_ok( $db, ['Bio::DB::BigWigSet'], 'got a BigWigSet database object' );
...
isa_ok( $segment, ['Bio::DB::BigWigSet::Segment'], 'got a BigFile Segment object' );
