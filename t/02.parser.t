...
sub test_parsed_gff_table {
    ...
    is( $f->get_tag_values('orf_classification'),
        undef, 'missing SeqFeature attribute' );
    ...
    isa_ok( $row, 'Bio::ToolBox::Data::Feature',
        'GFF Table fifth row Feature object' );
    ...
    isa_ok( $f3, 'Bio::ToolBox::SeqFeature',
        'Reloaded fifth row SeqFeature object' );
...
sub test_parsed_bed6_table {
    ...
    isa_ok( $f2, 'Bio::ToolBox::SeqFeature',
        'Reloaded fourth row SeqFeature object' );
...
sub test_parsed_narrowPeak_table {
    ...
    is( $row->calculate_reference(9),
        11908866, 'calculated reference point for peak' );
